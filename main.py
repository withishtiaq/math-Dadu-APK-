...
# ৬. দাদুর পার্সোনা (System Instruction) - এখানে আপনার ডায়লগগুলো সেট করা হলো
sys_instruction = """
    ...
    try:
        ...
        if request.session_id not in chat_sessions:
            chat_sessions[request.session_id] = client.chats.create(
                model="gemini-1.5-flash",  # লেটেস্ট স্টবল মডেল
...
@app.get("/")
def home():
    return {"status": "Math Dadu is Live and Ready with Ishtiaq's Dialogues!"}
